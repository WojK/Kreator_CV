...
const pl = {
  ...
  register_motivate: "Zarejestruj się i skorzystaj z porad doświadczonych rekruterów",
  register_name: "Imię:",
  ...
  editor_personal_submain_text: "Podaj swoje imię i nazwisko oraz dane kontaktowe, aby rekruter mógł do Ciebie napisać lub zadzwonić.",
  ...
  editor_profile_submain_text: "Opisz swój profil i udostępnij informacje o sobie!",
  ...
  editor_education_submain_text: "Dodaj swój najnowszy poziom wykształcenia - jeśli masz wyższe wykształcenie, nie podawaj informacji o szkole średniej, a jeśli masz wykształcenie średnie, nie pisz o edukacji podstawowej.",
  ...
  editor_projects_submain_text: "Teraz przedstaw projekty, na które jesteś dumny.",
  ...
  /*Editor-Skills Tab*/
  editor_skills_main_text: "Wymień Twoje umiejętności, które uważasz za najbardziej wartościowe",
  editor_skills_submain_text: "Dodanie umiejętności do swojego CV pozwala wyróżnić się i pokazać swoje kompetencje potencjalnym pracodawcom.",
  editor_skills_skill: "Umiejętności",
  /*Editor-Languages Tab*/
  editor_languages_main_text: "Języki obce",
  editor_languages_submain_text: "Dodaj języki obce, którymi posługujesz się, i określ swój poziom znajomości.",
  editor_languages_language: "Język",
  /*Editor-Hobby Tab*/
  editor_hobby_main_text: "Zainteresowania",
  editor_hobby_submain_text: "Dziel się swoimi zainteresowaniami, pokaż, co napędza Twoje życie.",
  editor_hobby_hobby: "Zainteresowanie",  
  /*Editor-Sum Tab*/
  editor_sum_main_text: "Już prawie gotowe! Zakończmy Twoje CV mocnym podsumowaniem.",
  editor_sum_clause: "Klauzula informacyjna RODO",
  editor_sum_clause_text: "I consent to the processing of my personal data by (company name) for the purpose of recruiting for the position I have applied for.",  
  /*Main page */
  main_page_section1_main_text: "Przedstaw swoje umiejętności i doświadczenie w sposób, który wyróżni cię z tłumu.",
  main_page_section1_button:"Stwórz CV Teraz!",
  main_page_section2_main_text: "Twój sukces zawodowy zaczyna się od porządnego CV",
  main_page_section2_benefit1: "Stwórz profesjonalne CV szybko i łatwo. Wszystko w kilku prostych krokach w przeglądarce.",
  main_page_section2_benefit2: "Zwiększ swoje szanse na zatrudnienie dzięki czystemu, schludnemu i dobrze zorganizowanemu CV.",
  main_page_section2_benefit3: "Przygotuj swoje CV zgodnie z powszechnie przyjętymi standardami, aby nie zapomnieć o żadnych istotnych szczegółach.",
  main_page_section3_main_text: "Stwórz swoje wymarzone CV",
  main_page_section3_benefit1_title: "Najwyższa Jakość",
  main_page_section3_benefit1: "Dzięki naszemu rozwiniętemu, a jednocześnie intuicyjnemu Kreatorowi CV tworzenie życiorysu to łatwizna. Generowanie jednego szablonu zajmuje mniej niż 2 minuty. Wystarczy wypełnić formularz.",
  main_page_section3_benefit2_title: "Profesjonalne Szablony",
  main_page_section3_benefit2: "Wybierz spośród 9 profesjonalnych szablonów CV. Zaprojektowanych przez ekspertów i zaadoptowanych przez osoby sukcesu.",
  ...
  technical_template_desc: "Techniczne szablony CV są predefiniowanymi formatami, które są specjalnie dostosowane dla osób pracujących w dziedzinach technicznych, takich jak inżynieria, informatyka czy nauka. Szablony te są zaprojektowane tak, aby klarownie i zwięźle prezentować umiejętności techniczne, wiedzę i osiągnięcia.",
  ...
  /*About us page*/
  about_us_1: "Projekt zrealizowany w niewilkim zespole prowadzony w oparciu o metodykę zwinną",
...
const en = {
  ...
  editor_personal_submain_text: "Enter your full name and contact information so a recruiter can write or call you.",
  ...
  editor_profile_submain_text: "Describe your profile and post information about yourself!",
  ...
  editor_education_submain_text: "Add your most recent level of education - if you have higher education - do not list secondary education, and if you have secondary education, do not write about primary education.",
  ...
  editor_skills_submain_text: "Adding skills to your CV allows you to stand out and showcase your abilities to potential employers.",
  editor_skills_skill: "Skill",
  /*Editor-Languages Tab*/
  editor_languages_main_text: "Foreign languages",
  editor_languages_submain_text: "Add the foreign languages you speak and specify your level of knowledge.",
  editor_languages_language: "Language",
  /*Editor-Hobby Tab*/
  editor_hobby_main_text: "Hobby",
  editor_hobby_submain_text: "Share your interests, show what drives your life.",
  editor_hobby_hobby: "Hobby",  
  /*Editor-Sum Tab*/
  editor_sum_main_text: "It's almost ready! Let's finish your resume with a strong summary.",
  editor_sum_clause: "Clause",
  editor_sum_clause_text: "I consent to the processing of my personal data by (company name) for the purpose of recruiting for the position I have applied for.",  
  /*Main page */
  main_page_section1_main_text: "Showcase your skills and experience in a way that makes you stand out from the crowd.",
  main_page_section1_button:"Create CV Right Now!",
  main_page_section2_main_text: "Your career success starts with well-designed CV",
  main_page_section2_benefit1: "Create a professional resume quickly and easily. All in a few quick steps in your browser.",
  main_page_section2_benefit2: "Boost your chance to get employed with sharp, clean and well-organised resume.",
  main_page_section2_benefit3: "Organize your CV with commonly known standards to do not forget all crucial details.",
  main_page_section3_main_text: "Create your dream CV",
  main_page_section3_benefit1_title: "Highest Quality",
  main_page_section3_benefit1: "With our advanced and intuitive CV Creator, creating a resume is a breeze. It takes less than 2 minutes to generate one template. Just complete form.",
  main_page_section3_benefit2_title: "Professional Templates",
  main_page_section3_benefit2: "Choose from 9 professional resume templates. Designed by experts and adopted by successful experts.",
  ...
  technical_template_desc: "Technical CV templates are pre-designed formats that are specifically tailored for individuals working in technical fields, such as engineering, IT, or science. These templates are designed to showcase technical skills, expertise, and achievements in a clear and concise manner.",  
