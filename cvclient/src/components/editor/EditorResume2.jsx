                        ...
                        <div className={classes["cv_section"]}>
                            ...
                            {experienceList.map((todo, index) => (
                                <ul key={index}>
                                    ...
                                    <h3>{todo.experienceFrom} - {todo.experienceTo}</h3>
                                    <h4>{todo.companyCity}</h4>
                                    <div className={classes.cv_section_desc}>
                                        <p>Odpowiedzielny za pozyskiwanie nowych klientow nawiazywan zywanie umow</p>
                                    </div>
                                    <hr />
                                </ul>
                            ))}
                        ...
                        <div className={classes["cv_section"]}>
                            ...
                            {educationList.map((todo, index) => (
                                <ul key={index}>
                                    ...
                                    <h3>{todo.schoolStartYear} - {todo.schoolFinishYear}</h3>
