            ...
            <div className={classes["tab-content"]}>
              ...
              <TabContent id={2}>
                ...
                <div className={`${classes["tab-content-forms"]}`}>
                  ...
                  <div className={classes["tab-content-form-100"]}>
                    <div>
                      <label htmlFor="schoolDescInput">School City:</label>
                      <input
                        id="schoolDescInput"
                        type="text"
                        value={schoolDesc}
              ...
              <TabContent id={3}>
                ...
                <div className={`${classes["tab-content-forms"]}`}>
                  ...
                  <div className={classes["tab-content-form-100"]}>
                    <label>Experince description</label>
                    <input
                      type="text"
                      value={experienceDesc}
                      onChange={(event) => setExperienceDesc(event.target.value)}
                    />
                  </div>
                  <div className={classes["to-right"]}>
                    <a
